...
#include "../../../../Users/Rizvi/Desktop/Server/user.h"
...
QT_MOC_LITERAL(1, 5, 10), // "needUpdate"
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (User::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&User::needUpdate)) {
                *result = 0;
                return;
            }
        }
